...
export default function InstitutionDashboard() {
  ...
  const pendingApprovals = [
    { id: 1, name: "Adhil Bijukumar", type: "student", department: "Computer Science" },
    { id: 2, name: "Dr. Michael Chen", type: "faculty", department: "Computer Science" },
    { id: 3, name: "Priya Sharma", type: "student", department: "Business Administration" }
  ];

  // Navigation items for sidebar
  const navItems = [
    { name: 'Home', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', href: '/dashboard/institution', active: true },
    { name: 'Departments', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', href: '/dashboard/institution/departments', active: false },
  ...
  return (
    <>
      <Head>
        <title>Institution Dashboard - Credify</title>
          ...
          <div className="bg-white px-6 pt-12 pb-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
                  <span className="text-sm font-semibold text-gray-600">
                    {institutionData.name.split(' ').map(n => n[0]).join('')}
                  </span>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Welcome,</p>
                  <p className="text-xs text-gray-400">{institutionData.name}</p>
                </div>
              </div>
              <button 
                onClick={() => router.push('/login')}
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              ...
              <div className="bg-yellow-50 rounded-xl p-4">
                ...
                <p className="text-lg font-bold text-yellow-700">{institutionData.pendingApprovals}</p>
              </div>
            </div>
          </div>
